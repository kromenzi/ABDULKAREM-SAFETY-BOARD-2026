      ...
      <div className={cn(
        ...
        {isCollapsed && !mobile ? (
          <img 
            ...
            alt="Logo" 
            className="h-[34px] w-[34px] rounded-xl brand-logo-mark drop-shadow-sm transition-all ring-1 ring-white/15 object-contain"
          ...
          <div className="flex items-center gap-2.5 flex-1 min-w-0">
            <img 
              src={settings.branding?.companyLogo || "/logo.png"} 
              alt="Logo" 
              className="h-9 w-[54px] brand-logo-full drop-shadow-sm shrink-0 transition-all object-contain"
              referrerPolicy="no-referrer"
              onError={(e) => {
                if (e.currentTarget.src !== window.location.origin + '/logo.png') {
                  e.currentTarget.src = '/logo.png';
